...
Status: Round 3 initial authoring API
...
The API is report-only in Round 3. It is intentionally not wired into the default selector anti-clone command yet, because existing tutorial/baseline cases may stay available while being excluded from the Phase 23 4+ quota.
