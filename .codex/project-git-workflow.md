...
<!-- initialized-at: 2026-06-23 03:49:55 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: RoomAxioms
Repository root: D:/WebProjects/RoomAxioms
Machine config: `
...
```
powershell
git -c safe.directory=D:/WebProjects/RoomAxioms status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/RoomAxioms push -u origin HEAD
```
